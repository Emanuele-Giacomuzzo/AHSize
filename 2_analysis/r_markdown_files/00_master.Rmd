...
save.image(file = here("..",
                       "3_results", 
                       "R_environments", 
                       "R_environment_before_new_code.RData"))
```

```{r child = here("r_markdown_files", "A_analyse_metaecos_time_points.Rmd")}
```
...
#### Biomass (time points) {.tabset .tabset-dropdown}
...
```{r child = here("r_markdown_files", "B_analyse_ecos_time_points.Rmd")}
```
